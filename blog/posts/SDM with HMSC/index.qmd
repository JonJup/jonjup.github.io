 ...
 *<span style="color:CornflowerBlue">distr</span>* is the distribution function    
 *<span style="color:CornflowerBlue">ranLevels</span>* needs to be a list, even if you only have one random level. 
...
model=list()
model[[1]]=readRDS("hmsc_cm_models5.RDS")[[1]]
model[[2]]=readRDS("hmsc_cm_models10.RDS")[[1]]
model[[3]]=readRDS("hmsc_cm_models100.RDS")[[1]]
```
...
MF=readRDS("predictive_performance.RDS")
```
